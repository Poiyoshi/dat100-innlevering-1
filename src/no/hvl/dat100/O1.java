...
public class O1 {
	...
	public static void main(String[] args) {
		...
		if(inntekt <= 208050) {
			...
			double skatt = ((292850 - 208050) * 0.017) + ((670000 - 292850) * 0.04) + ((937900 - 670000) * 0.136) + ((inntekt - 937900) * 0.166);
			System.out.println("Du betaler " + skatt + " i skatt med en inntekt på " + inntekt);
		}else if(inntekt > 1350000) {
			double skatt = ((292850 - 208050) * 0.017) + ((670000 - 292850) * 0.04) + ((937900 - 670000) * 0.136) + ((1350000 - 937900) * 0.166) + ((inntekt - 1350000) * 0.176);
			System.out.println("Du betaler " + skatt + " i skatt med en inntekt på " + inntekt);
		}
